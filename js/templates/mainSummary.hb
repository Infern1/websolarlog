...
<div class="cl"></div>
	<div class="column span-3 horizontalLine">
		<br>
		Power:<br>
		CO2:<br>
		Money:<br>
...
<div class="cl"></div>
	<div class="column span-4 verticalLine">
	House:<br>
		Trees:<span title="The household produces {{data.totals.householdCO2}} kg CO2 and a tree consumses {{data.totals.co2CompensationTree}} grams of CO2 a day so we need {{data.totals.totalUsageCO2Trees}} trees to compensate this">{{data.totals.householdTrees}}</span><br>
		<span title="Used Power is {{data.totals.totalUsageKWHCO2}} kg CO2 combined with {{data.totals.metering.gasUsageCO2}} kg CO2 for gas gives a total of {{data.totals.householdCO2}} kg for the household">{{data.totals.householdCO2}} kg</span><br>
	</div>
</div>
