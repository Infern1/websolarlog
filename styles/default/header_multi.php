	...
	<table width="90%" border="0" cellspacing="0" cellpadding="0"
		...
		<tr bgcolor="#FFFFFF">
			<td class="cadretopleft" width="128"><img
				src="styles/<?php echo $user_style;?>/images/sun12880.png"
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="5"
									...
									<tr>
										<td><font class="menu"><img
												src="styles/<?php echo $user_style;?>/images/sqe.gif"
												width="13" height="9"><a href="index_multi.php"><?php echo "$lgMINDEX";?>
											</a>
										</font>
										</td>
									</tr>
