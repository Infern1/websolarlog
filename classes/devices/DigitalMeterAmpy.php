<?php
Class DigitalMeterAmpy implements DeviceApi {
    private $ADR;
    private $DEBUG;
    private $PATH;
...
!';
    ...
    public function getLiveData() {
    	...
    	$data = explode("\n",$this->getData());
    	//echo "\r\ndata:".var_dump($data)."\r\n";
    	return DigitalMeterAmpyConverter::toLiveSmartMeter($data);
    }
    ...
    private function execute() {
    	...
    	foreach ($badApp as $app) {
    		if (strpos($uri, $app . " ") !== false) {
    			HookHandler::getInstance()->fire("onError", "DigitalMeterAmpy path contains blacklisted program: " . $app);
    			return null;
    		}
    	}
