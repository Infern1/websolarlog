<form>
  ...
  <fieldset>
   ...
   <span style="color:#f00;">We recommend to use SMAspot >=2.0.6</span><br>
    ...
    <label for="mastervoltpath">Mastervolt (RS485):</label><input type="text" name="mastervoltpath" value="{{data.mastervoltpath}}" size="50"/><br />
    <label for="soladinsolgetpath">Soladin Solget(RS232):</label><input type="text" name="soladinSolgetpath" value="{{data.soladinSolgetpath}}" size="50"/><br />
