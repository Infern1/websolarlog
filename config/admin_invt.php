							...
							<table border="0" cellspacing="10" cellpadding="0" width="100%"
								...
								<tr valign="top">
									<td>
										...
										if (!empty ($_POST['invt_num2'])) {
											$invt_num2= $_POST['invt_num2'];
										}
										if (!empty ($_POST['ADR2'])) {
											$ADR2 = $_POST['ADR2'];
										}
										if (!empty ($_POST['LOGCOM2'])) {
											$LOGCOM2 = $_POST['LOGCOM2'];
										}
										if (!empty ($_POST['PLANT_POWER2'])) {
											$PLANT_POWER2 = $_POST['PLANT_POWER2'];
										}
										if (!empty ($_POST['CORRECTFACTOR2'])) {
											$CORRECTFACTOR2 = $_POST['CORRECTFACTOR2'];
										}
										if (!empty ($_POST['INITIALCOUNT2'])) {
											$INITIALCOUNT2 = $_POST['INITIALCOUNT2'];
										} else { $INITIALCOUNT2=0;
										}
										if (!empty ($_POST['INVNAME2'])) {
											$INVNAME2 = $_POST['INVNAME2'];
										}
										if (!empty ($_POST['YMAX2'])) {
											$YMAX2 = $_POST['YMAX2'];
										}
										if (!empty ($_POST['YINTERVAL2'])) {
											$YINTERVAL2 = $_POST['YINTERVAL2'];
										}
										if (!empty ($_POST['PRODXDAYS2'])) {
											$PRODXDAYS2 = $_POST['PRODXDAYS2'];
										}
										if (!empty ($_POST['LOCATION2'])) {
											$LOCATION2 = $_POST['LOCATION2'];
										}
										if (!empty ($_POST['PANELS12'])) {
											$PANELS12 = $_POST['PANELS12'];
										}
										if (!empty ($_POST['ROOF_ORIENTATION12'])) {
											$ROOF_ORIENTATION12 = $_POST['ROOF_ORIENTATION12'];
										}
										if (!empty ($_POST['ROOF_PICTH12'])) {
											$ROOF_PICTH12 = $_POST['ROOF_PICTH12'];
										}
										if (!empty ($_POST['PANELS22'])) {
											$PANELS22 = $_POST['PANELS22'];
										}
										if (!empty ($_POST['ROOF_ORIENTATION22'])) {
											$ROOF_ORIENTATION22 = $_POST['ROOF_ORIENTATION22'];
										}
										if (!empty ($_POST['ROOF_PICTH22'])) {
											$ROOF_PICTH22 = $_POST['ROOF_PICTH22'];
										}
										if (!empty ($_POST['EXPECTEDPROD2'])) {
											$EXPECTEDPROD2 = $_POST['EXPECTEDPROD2'];
										}
										if (!empty ($_POST['EXPECTJAN2'])) {
											$EXPECTJAN2 = $_POST['EXPECTJAN2'];
										}
										if (!empty ($_POST['EXPECTFEB2'])) {
											$EXPECTFEB2 = $_POST['EXPECTFEB2'];
										}
										if (!empty ($_POST['EXPECTMAR2'])) {
											$EXPECTMAR2 = $_POST['EXPECTMAR2'];
										}
										if (!empty ($_POST['EXPECTAPR2'])) {
											$EXPECTAPR2 = $_POST['EXPECTAPR2'];
										}
										if (!empty ($_POST['EXPECTMAY2'])) {
											$EXPECTMAY2 = $_POST['EXPECTMAY2'];
										}
										if (!empty ($_POST['EXPECTJUN2'])) {
											$EXPECTJUN2 = $_POST['EXPECTJUN2'];
										}
										if (!empty ($_POST['EXPECTJUI2'])) {
											$EXPECTJUI2 = $_POST['EXPECTJUI2'];
										}
										if (!empty ($_POST['EXPECTAUG2'])) {
											$EXPECTAUG2 = $_POST['EXPECTAUG2'];
										}
										if (!empty ($_POST['EXPECTSEP2'])) {
											$EXPECTSEP2 = $_POST['EXPECTSEP2'];
										}
										if (!empty ($_POST['EXPECTOCT2'])) {
											$EXPECTOCT2 = $_POST['EXPECTOCT2'];
										}
										if (!empty ($_POST['EXPECTNOV2'])) {
											$EXPECTNOV2 = $_POST['EXPECTNOV2'];
										}
										if (!empty ($_POST['EXPECTDEC2'])) {
											$EXPECTDEC2 = $_POST['EXPECTDEC2'];
										}
										...
										if ($Err!=true) {
											...
											if (!file_exists('../data/invt'.$invt_num2.'/')) {
												mkdir("../data/invt$invt_num2");
											}
											if (!file_exists('../data/invt'.$invt_num2.'/csv')) {
												mkdir("../data/invt$invt_num2/csv");
											}
											if (!file_exists('../data/invt'.$invt_num2.'/infos')) {
												mkdir("../data/invt$invt_num2/infos");
											}
											if (!file_exists('../data/invt'.$invt_num2.'/production')) {
												mkdir("../data/invt$invt_num2/production");
											}
											if (!file_exists('../data/invt'.$invt_num2.'/errors')) {
												mkdir("../data/invt$invt_num2/errors");
											}
