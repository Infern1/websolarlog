...
if (!empty ($_POST['PORT2'])) { $PORT2 = $_POST['PORT2']; }
if (!empty ($_POST['COMOPTION2'])) { $COMOPTION2 = $_POST['COMOPTION2']; }
if (!empty ($_POST['DEBUG2'])) { $DEBUG2 = $_POST['DEBUG2']; }
if (!empty ($_POST['SYNC2'])) { $SYNC2 = $_POST['SYNC2']; }
if (!empty ($_POST['NUMINV2'])) { $NUMINV2 = $_POST['NUMINV2']; }
if (!empty ($_POST['AUTOMODE2'])) { $AUTOMODE2 = $_POST['AUTOMODE2']; }
if (!empty ($_POST['LATITUDE2'])) { $LATITUDE2 = $_POST['LATITUDE2']; }
if (!empty ($_POST['LONGITUDE2'])) { $LONGITUDE2 = $_POST['LONGITUDE2']; }
if (!empty ($_POST['SENDALARMS2'])) { $SENDALARMS2 = $_POST['SENDALARMS2']; }
if (!empty ($_POST['SENDMSGS2'])) { $SENDMSGS2 = $_POST['SENDMSGS2']; }
if (!empty ($_POST['FILTER2'])) { $FILTER2 = $_POST['FILTER2']; }
if (!empty ($_POST['EMAIL2'])) { $EMAIL2 = $_POST['EMAIL2']; }
if (!empty ($_POST['KEEPDDAYS2'])) { $KEEPDDAYS2 = $_POST['KEEPDDAYS2']; }
if (!empty ($_POST['AMOUNTLOG2'])) { $AMOUNTLOG2 = $_POST['AMOUNTLOG2']; }
if (!empty ($_POST['TITLE2'])) { $TITLE2 = $_POST['TITLE2']; }
if (!empty ($_POST['SUBTITLE2'])) { $SUBTITLE2 = $_POST['SUBTITLE2']; }
if (!empty ($_POST['PVOUTPUT2'])) { $PVOUTPUT2 = $_POST['PVOUTPUT2']; }
if (!empty ($_POST['APIKEY2'])) { $APIKEY2 = $_POST['APIKEY2']; }
if (!empty ($_POST['SYSID2'])) { $SYSID2 = $_POST['SYSID2']; }
