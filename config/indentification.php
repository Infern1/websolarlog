							...
							<table border="0" cellspacing="10" cellpadding="0" width="100%"
								...
								<tr valign="top">
									<td>
										...
										if ($err==1) {
											echo "<br><div align=center><font color='#8B0000'><b>Login or password incorrect</b></font><br><br><INPUT type='button' value='Back' onclick='history.back()'></div>";
										}
										if ($err==2) {
											echo "<br><div align=center><font color='#8B0000'><b>Enter a login and a password</b></font><br><br><INPUT type='button' value='Back' onclick='history.back()'></div>";
										}
										?> <!-- #EndEditable -->
