...
if (!empty ($_GET['whichmonth'])) { $whichmonth= $_GET['whichmonth']; } else { $whichmonth=date("n"); } 
if (!empty ($_GET['whichyear'])) { $whichyear= $_GET['whichyear']; } else { $whichyear= date("Y"); }
if (!empty ($_GET['comparemonth'])) { $comparemonth= $_GET['comparemonth']; } else { $comparemonth=date("n"); } 
if (!empty ($_GET['compareyear'])) { $compareyear= $_GET['compareyear']; } else { $compareyear= "expected"; }
