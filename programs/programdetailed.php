...
if (!empty ($_GET['checkpower'])) {
	$checkpower = $_GET['checkpower']; $rowstoreturn++;
} else { $checkpower=FALSE;
}
if (!empty ($_GET['checkavgpower'])) {
	$checkavgpower = $_GET['checkavgpower']; $rowstoreturn++;
} else { $checkavgpower=FALSE;
}
if (!empty ($_GET['checkI1V'])) {
	$checkI1V = $_GET['checkI1V']; $rowstoreturn++;
} else { $checkI1V=FALSE;
}
if (!empty ($_GET['checkI1A'])) {
	$checkI1A = $_GET['checkI1A']; $rowstoreturn++;
} else { $checkI1A=FALSE;
}
if (!empty ($_GET['checkI1P'])) {
	$checkI1P = $_GET['checkI1P']; $rowstoreturn++;
} else { $checkI1P=FALSE;
}
if (!empty ($_GET['checkI2V'])) {
	$checkI2V = $_GET['checkI2V']; $rowstoreturn++;
} else { $checkI2V=FALSE;
}
if (!empty ($_GET['checkI2A'])) {
	$checkI2A = $_GET['checkI2A']; $rowstoreturn++;
} else { $checkI2A=FALSE;
}
if (!empty ($_GET['checkI2P'])) {
	$checkI2P = $_GET['checkI2P']; $rowstoreturn++;
} else { $checkI2P=FALSE;
}
if (!empty ($_GET['checkGV'])) {
	$checkGV = $_GET['checkGV']; $rowstoreturn++;
} else { $checkGV=FALSE;
}
if (!empty ($_GET['checkGA'])) {
	$checkGA = $_GET['checkGA']; $rowstoreturn++;
} else { $checkGA=FALSE;
}
if (!empty ($_GET['checkGP'])) {
	$checkGP = $_GET['checkGP']; $rowstoreturn++;
} else { $checkGP=FALSE;
}
if (!empty ($_GET['checkFRQ'])) {
	$checkFRQ = $_GET['checkFRQ']; $rowstoreturn++;
} else { $checkFRQ=FALSE;
}
if (!empty ($_GET['checkEFF'])) {
	$checkEFF = $_GET['checkEFF']; $rowstoreturn++;
} else { $checkEFF=FALSE;
}
if (!empty ($_GET['checkINVT'])) {
	$checkINVT = $_GET['checkINVT']; $rowstoreturn++;
} else { $checkINVT=FALSE;
}
if (!empty ($_GET['checkBOOT'])) {
	$checkBOOT = $_GET['checkBOOT']; $rowstoreturn++;
